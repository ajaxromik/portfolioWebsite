  ...
  <div class="mt-5 bg-new-light text-new-dark flex-grow-1 d-flex flex-column">
    <section class="flex-grow-1 d-flex flex-column justify-content-center py-5 px-4 container">
      <div class="row mx-md-0 gx-5 text-center">
        ...
        <div class="col-6 col-md-12">
          ...
          <p class="text-muted mb-2">Anticipated Graduation May 2026</p>
      ...
      <div class="container text-center">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 text-start fs-5">
            <p><strong>Languages and Other Technologies:</strong> PHP, MySQL, Linux CLI, Python, Java, Bootstrap, Sass, Vue.js, React, React Native, Smarty, JavaScript, D3.js, HTML, CSS, C++, MongoDB, Neo4j</p>
            <p><strong>Other Relevant Skills:</strong> Prompt Engineering, Unit Testing, Code Review, Web Development, Relational Database Design, Object-Oriented Design, Visual Analytics, Version Control, Data Cleaning</p>
            <p><strong>Soft Skills:</strong> Adaptability, Effective Communication, Attention to Detail, Problem Solving, Prioritization, Techical Writing</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="flex-grow-1 d-flex flex-column justify-content-center py-5 text-center">
      <div class="container">
        ...
        <a href="/WilliamCarrResume.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-lg">View PDF Resume</a>
      </div>
    </section>
  </div>
</template>